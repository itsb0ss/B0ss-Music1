    ...
    try {
        ...
        if (!client.riffy.nodes || client.riffy.nodes.size === 0) {
            const embed = new EmbedBuilder()
                ...
                .setDescription('❌ No available Lavalink nodes to process the request, contact <@636615832218239016>.');
...
module.exports = {
    ...
    options: [{
        name: 'name',
        description: 'Enter a song name, link or playlist.',
